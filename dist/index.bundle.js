  ...
  #cpuFireAttack() {
    ...
    switch(status) {
      case 1: {
        ...
        if (cpu.behavior === _player__WEBPACK_IMPORTED_MODULE_1__.CPU_STATE.random
          && cpu.cpuFirstSuccessfulHit.row === null
        ) {
          cpu.cpuFirstSuccessfulHit.row = row;
          cpu.cpuFirstSuccessfulHit.col = col;
          cpu.behavior = _player__WEBPACK_IMPORTED_MODULE_1__.CPU_STATE.found;
        // The CPU has made a second successful hit while in found mode!
        } else if (cpu.behavior === _player__WEBPACK_IMPORTED_MODULE_1__.CPU_STATE.found
          && cpu.cpuSecondSuccessfulHit.row === null
        ) {
          cpu.cpuSecondSuccessfulHit.row = row;
          cpu.cpuSecondSuccessfulHit.col = col;
          cpu.behavior = _player__WEBPACK_IMPORTED_MODULE_1__.CPU_STATE.focused;
        } else {
          // focused mode behaviors -- revert to random whe sunk.
          if (cpu.behavior === _player__WEBPACK_IMPORTED_MODULE_1__.CPU_STATE.focused) {
          ...
          if (shipSunk) {
            ...
            cpu.behavior = _player__WEBPACK_IMPORTED_MODULE_1__.CPU_STATE.random;
            cpu.cpuFocusInvert = false;
          }
        }
        break;
