    ...
    switch(status) {
      case 1: {
        ...
        if (this.players[1].cpuFirstSuccessfulHit.row === null) {
          ...
          this.players[1].CPU_STATE = _player__WEBPACK_IMPORTED_MODULE_2__.CPU_STATE.found;
          ...
          this.players[1].CPU_STATE = _player__WEBPACK_IMPORTED_MODULE_2__.CPU_STATE.focused;
        } else {
          ...
          if (shipSunk) {
            ...
            this.players[1].CPU_STATE = _player__WEBPACK_IMPORTED_MODULE_2__.CPU_STATE.random;
          }
        }
        break;
      }
